...
const WaterMaterial = shaderMaterial(
  ...
  `
    ...
    void main() {
      ...
      float elevation =
  (sin(modelPosition.x * 0.06 + uTime * 0.8) * 0.5 + 0.5) * 0.38 +
  (sin(modelPosition.z * 0.08 + uTime * 0.6) * 0.5 + 0.5) * 0.30 +
  (sin(modelPosition.x * 0.03 + modelPosition.z * 0.04 + uTime * 0.4) * 0.5 + 0.5) * 0.20;
